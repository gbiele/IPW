...
MFR =read_sav("data/PDB2014_MFR_410_v9.sav");
...
MFR = MFR[,Cidx]
names(MFR) = c("PID","CN","HELSEREGION","byear","mAge","fAge","MarSt","Parity","Epil",
               "MULTIVU","FOLATU","weeks_UL","weeks_MS","weight","length","cSEX","APGAR5",
...
#####################################################
# for eduction, income:
load("data/PDB2014_Q1_v9_red.Rdata");


nms = c("PID","mpreWght1", "mpreWght2","mTall", "fTall","fWght", "mEDUcomp","mEDUcur",
        "fEDUcomp","fEDUcur","mINC","fINC","mSCL_Fear_Q1", "mSCL_Nervous_Q1",
        "mSCL_Hopeless_Q1", "mSCL_Blue_Q1", "mSCL_Worry_Q1", "mFeel_Pos_Q1", 
        "mFeel_Useless_Q1", "mFeel_NotProud_Q1", "mFeel_Valuabel_Q1",
        ...
        "mALC_EVER", "mALC_FREQ_befPreg", "mALC_FREQ_durPreg", "mALC_BINGE_befPreg",
        "mALC_BINGE_durPreg", "mALC_TYPUNITS_befPreg", "mALC_TYPUNITS_durPreg",
        "mALC_TACE_EFFUNITS", "mALC_TACE_HurtCrit", "mALC_TACE_OughtLESS", 
        "mALC_TACE_DrinkMorn", "mALC_RAPI_argued", "mALC_RAPI_SuddFound", "mALC_RAPI_Absence", 
        "mALC_RAPI_Fainted", "mALC_RAPI_SadPeriod", "CivilStatus")
names(MoBa1) = nms
...
MoBa1$CivilStatus = factor(as.numeric(MoBa1$CivilStatus)
                           labels = c("married","cohabitating","Single","Other"))
...
Q3 = read_sav("data/PDB2014_Q3_v9.sav");
...
load("data/SMOK_PDB2014_Q1_v9.Rdata")
names(M1smoke) = c("PID", "fSMOK_befPreg","fSMOK_aftPreg","SMOK_EVER", "SMOK_aftPreg", 
                   "SMOK_aftPreg_perWeek","SMOK_aftPreg_perDay",
...
load("data/PDB2014_Q4_6mnd_v9_red.sav")
...
#####################################################
MoBa6 = read_sav("data/PDB2014_Q6_3aar_v9.sav");
...
MoBa6HP =  read_sav("data/PDB2014_Q6_3aar_v9.sav");
cHPidx = c("PREG_ID_2014","BARN_NR",paste("GG",29:116,sep = ""))

HPS = c("Hearing","Vision","Motor","CerebralPalsy","Joints","Diabetes","ToLight",
        "ToHeavy","Heart","Testicle", "Asthma","Allergi","AtopicEczema", 
...
MoBaF = read_sav("data/PDB2014_QF_v9.sav");
...
for (v in names(RD)) {
  if (is.factor(RD[,v])) {
    if (sum(levels(RD[,v]) == "NaN") > 0) {
      ...
      print(paste0(paste(new_levels, collapse = ", "),"  ::  ",
                   paste(levels(RD[,v]), collapse = ", ")))
