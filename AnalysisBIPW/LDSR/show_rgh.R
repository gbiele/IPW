...
vn = c("p1","p2","rg","se","z","p",
       "h2_obs","h2_obs_se","h2_in","h2_int_se",
...
lvls = c("ADHD","YearsEdu","AgeFirstBirth","NumChildrBorn","BirthWeight",
         "EverSmoked","CigPerDay","AlcUse","DeprSymp","Anxiety","Cannabis")
